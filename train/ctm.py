...
from quadrotor_diffusion.models.distillation import ConsistencyTrajectoryTrainer
...
diff_model = ConsistencyTrajectoryWrapper((
    diff_args,
    unet_args,
))
...
trainer = ConsistencyTrajectoryTrainer(
    train_args,
    diff_model,
    dataset,
)
